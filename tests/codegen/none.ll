...
@const_str.3 = private constant [13 x i8] c"no allocation"
...
Block_4:                                          ; preds = %Block_6
  ...
  %set_pay = insertvalue { i8, [8 x i8] } { i8 0, [8 x i8] undef }, [8 x i8] %load4, 1
...
Block_5:                                          ; preds = %entry
  call void @fmt_println({ i64, ptr } { i64 13, ptr @const_str.3 })
  br label %Block_6
